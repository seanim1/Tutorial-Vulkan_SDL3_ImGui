...
void update_gui(AppState* app)
{
    ...
    if (app->show_gui) {
        ...
        ImGui::Separator();
        ImGui::ColorEdit3("Triangle color", glm::value_ptr(app->triangle_color));
...
SDL_AppResult SDL_AppInit(void** appstate, int argc, char* argv[]) {
    ...
    *appstate = app.release();
    ...
    app->window = SDL_CreateWindow("Part 08 - glm", WINDOW_WIDTH, WINDOW_HEIGHT, SDL_WINDOW_VULKAN);
    if (!app->window) {
