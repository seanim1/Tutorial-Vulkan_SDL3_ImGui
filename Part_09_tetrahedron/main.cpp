...
const Vertex vertices[] = {
    {{ 0.0f,  1.0f,  0.0f}},        // top
    {{ 0.0f, -1.0f,  1.1547f}},     // front
    {{-1.0f, -1.0f, -0.5774f}},     // back left
    {{ 1.0f, -1.0f, -0.5774f}},     // back right
};
...
void update_uniform_buffer(AppState* app, uint32_t image_index)
{
    ...
    app->rotation_y += dt * 20.0f; // auto-rotate Y at 20 degrees per second
...
SDL_AppResult SDL_AppInit(void** appstate, int argc, char* argv[]) {
    ...
    *appstate = app.release();
    ...
    app->window = SDL_CreateWindow("Part 09 - Tetrahedron", WINDOW_WIDTH, WINDOW_HEIGHT, SDL_WINDOW_VULKAN);
    if (!app->window) {
